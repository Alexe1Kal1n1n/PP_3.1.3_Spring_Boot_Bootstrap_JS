...
function edit() {
    ...
    let last_name = document.getElementById('editLast_Name').value;
    ...
    fetch('/api/admin/' + id)
        ...
        .then(user => {
            ...
            modal.innerHTML = '<div class="modal fade"  id="modalEdit"  tabindex="-1" role="dialog" aria-hidden="true">\n' +
                ...
                '                                               class="form-control"\n' +
                '                                               name="last_name"\n' +
                '                                               id="editLast_Name" value="' + user.last_name + '"\n' +
                '                                               required>\n' +
                '                                        <br>\n' +
...
async function addNewUser() {
    await document.getElementById('new').addEventListener('submit', e => {
        ...
        let last_name = document.getElementById('newLast_Name').value;
